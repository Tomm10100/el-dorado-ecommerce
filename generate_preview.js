...
const b64Images = images.map(img => imageToBase64(img));
    ...
    <div class="container">
        <div class="product-grid">
            <div class="product-card">
                <div class="product-image"><img src="${b64Images[0]}" alt="Lunar Heavy Cuban"></div>
            ...
            <div class="product-card">
                <div class="product-image"><img src="${b64Images[1]}" alt="Celestial Tennis"></div>
            ...
            <div class="product-card">
                <div class="product-image"><img src="${b64Images[2]}" alt="Resonant Link"></div>
            ...
            <div class="product-card">
                <div class="product-image"><img src="${b64Images[3]}" alt="Architectural Band"></div>
...
fs.writeFileSync("c:/Users/Ryzen 9 5900X/Desktop/Antigravity/EL_DORADO_SHAREABLE_PREVIEW.html", htmlTemplate);
console.log("Standalone HTML generated successfully with embedded images.");
